...
LLM para realizar a triagem das URLs e gerar alertas.

`n8n` · `APIs REST` · `Automação` · `Segurança`
...
**C4 Model**, wireframes de média e alta fidelidade, protótipo
interativo e teste de usabilidade.

`BPMN` · `UML` · `C4 Model` · `UX` · `Figma`
